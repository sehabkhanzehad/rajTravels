...
@section("head")
    ...
    <link rel="stylesheet" href="{{ asset('assets') }}/adminDashboard/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css">
...
@section("script")
    ...
    <script src="{{ asset('assets') }}/adminDashboard/vendors/chartjs/Chart.min.js"></script>
    <script src="{{ asset('assets') }}/adminDashboard/vendors/jquery.flot/jquery.flot.js"></script>
    <script src="{{ asset('assets') }}/adminDashboard/vendors/jquery.flot/jquery.flot.resize.js"></script>
    <script src="{{ asset('assets') }}/adminDashboard/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
    <script src="{{ asset('assets') }}/adminDashboard/vendors/apexcharts/apexcharts.min.js"></script>
    <script src="{{ asset('assets') }}/adminDashboard/vendors/progressbar.js/progressbar.min.js"></script>
    <!-- end plugin js for this page -->

  <!-- custom js for this page -->
  <script src="{{ asset('assets') }}/adminDashboard/js/dashboard.js"></script>
  <script src="{{ asset('assets') }}/adminDashboard/js/datepicker.js"></script>
